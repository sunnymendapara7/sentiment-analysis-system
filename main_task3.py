...
#                 else:
#                     logging.error(f"Groq API call failed after {max_retries} attempts: {e}")
#                     return None
#     except Exception as e:
...
#                 f"Failed to generate test cases due to API error.\n"
#             )
#         else:
...
#     except Exception as e:
#         logging.error(f"Failed to add test cases to Jira ticket {task_key}: {e}")
#         print(f"Error adding test cases to Jira ticket {task_key}: {e}")
...
#         except Exception as e:
#             logging.error(f"Error committing test cases for {task_key} to {branch_name}: {e}")
#             print(f"Error committing test cases for {task_key}: {e}")
...
#     except Exception as e:
#         logging.error(f"Error saving test cases to {output_file}: {e}")
...
#     except Exception as e:
#         logging.error(f"Error accessing GitHub repository: {e}")
